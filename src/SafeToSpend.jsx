  ...
  return (
    <div className="min-h-screen w-full flex justify-center" style={{ background: C.app }}>
      ...
      >
        ...
        {/* ------------------ content ------------------ */}
        <div className="app-scroll px-3 pt-4" style={{ paddingBottom: 16 }}>
          {tab === 0 && (
        ...
        {/* clearance for the fixed nav, in the page colour not the card */}
        <div style={{ height: 88, background: C.surface }} />
